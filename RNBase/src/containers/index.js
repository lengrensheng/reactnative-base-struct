      ...
      return(
        <TouchableOpacity onPress={onPress}>
          <View style={[styles.navBarItem,styles.navBarRightButton]}>
            {rightTitle?<Text style={[styles.navBarTitle,{color:rightColor?rightColor:
            'white'}]}>{rightTitle}</Text>:<Image source={source}/>}
          </View>
        </TouchableOpacity>
      )
    }
  ...
  Title(route,navigator,index,navState){
    ...
    return(
      <View style={[styles.navBarItem,styles.navBarTitle]}>
        <Text style={[styles.navBarTitleText,isWhite?styles.navBarTitleWhiteText:{}]}>{getSceneProps(route,navigator,kNavTitle)}</Text>
      </View>
    )
  },
};
